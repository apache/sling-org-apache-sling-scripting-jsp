...
public class JspRuntimeLibrary {
    ...
    protected static class PrivilegedIntrospectHelper implements PrivilegedExceptionAction<Object> {
        public Object run() throws JasperException {
            throw new UnsupportedOperationException("PrivilegedIntrospectHelper retained only for binary compatibility");
        }
    }
