...
public class UTF8Reader extends Reader {
    ...
    public int read() throws IOException {
        ...
        // return character
        if (DEBUG_READ) {
            if (log.isDebugEnabled()) log.debug("read(): 0x" + Integer.toHexString(c));
        }
        return c;
    } // read():int
    ...
    public int read(char ch[], int offset, int length) throws IOException {
        ...
        if (DEBUG_READ) {
            if (log.isDebugEnabled()) log.debug("read(char[]," + offset + ',' + length + "): count=" + count);
        }
        return count;
    } // read(char[],int,int)
    ...
    private void expectedByte(int position, int count) throws UTFDataFormatException {
        ...
        throw new UTFDataFormatException(Localizer.getMessage(
                "jsp.error.xml.expectedByte", Integer.toString(position), Integer.toString(count)));
