...
public class Url implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource("String " + baseUrlName + " = "
                + "org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.resolveUrl(" + valueName + ", "
        ...
        ctxt.generateJavaSource(
                "if(!org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + resultName + ")){");
