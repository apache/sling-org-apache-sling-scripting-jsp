...
public class PageContextImpl extends PageContext {
    ...
    private void doHandlePageException(Throwable t) throws IOException, ServletException {
        ...
        if (errorPageURL != null && !errorPageURL.equals("")) {
            ...
            request.setAttribute(
                    "javax.servlet.error.status_code", new Integer(HttpServletResponse.SC_INTERNAL_SERVER_ERROR));
    ...
    public static Object proprietaryEvaluate(
            ...
            throws ELException {
        Object retValue;
        final ExpressionFactory exprFactory = JspFactory.getDefaultFactory()
