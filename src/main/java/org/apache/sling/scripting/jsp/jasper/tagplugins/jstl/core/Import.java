    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        if (hasVarReader) {
            ...
            ctxt.generateJavaSource("            " + charSetName + " = "
                    + "org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.getContentTypeAttribute("
                    + contentTypeName + ", \"charset\");");
            ctxt.generateJavaSource("            if(" + charSetName + " == null) " + charSetName
                    + " = org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ...
            ctxt.generateJavaSource("    RequestDispatcher " + requestDispatcherName + " = " + servletContextName
                    + ".getRequestDispatcher(org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.stripSession("
                    + urlName + "));");
            ctxt.generateJavaSource("    if(" + requestDispatcherName
                    + " == null) throw new JspTagException(org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.stripSession("
                    + urlName + "));");

            // initialize a ImportResponseWrapper to include the resource
            ctxt.generateJavaSource(
                    "    org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.ImportResponseWrapper " + irwName
                            + " = new org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.ImportResponseWrapper((HttpServletResponse) pageContext.getResponse());");
            ctxt.generateJavaSource("    if(" + charSetName + " == null){");
            ctxt.generateJavaSource("        " + charSetName
                    + " = org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("        throw new JspTagException(" + irwName
                    + ".getStatus()+\" \" + org.apache.sling.scripting.jsp.jasper.tagplugins.jstl.Util.stripSession("
                    + urlName + "));");
            ctxt.generateJavaSource("    }");
